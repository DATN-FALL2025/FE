...
export async function createPosition(formData, token) {
  try {
    ...
    const url = `${API_BASE_URL}/position/createPosition`;
...
export async function updatePositionById(id, formData, token) {
  try {
    ...
    const url = `${API_BASE_URL}/position/updatePositionById/${id}`;
...
export async function deletePositionById(id, token) {
  try {
    ...
    const url = `${API_BASE_URL}/position/deletePositionById/${id}`;
