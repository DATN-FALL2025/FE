...
const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL 
  ...
  : 'https://manage-and-automate-aviation-academy-application-production.up.railway.app/api';

/**
 * Get authorization token from request headers
 * Since we're using 'use server', we need to pass token from client
...
export async function uploadTraineeApplication(traineeApplicationId, token = null) {
  try {
    ...
    console.log('📤 Upload Trainee Application:', { traineeApplicationId, hasToken: !!authToken });
