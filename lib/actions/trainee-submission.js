 ...
 * @param {string} [updateData.requireDocumentName] - Tên document yêu cầu
...
export async function getAllTraineeApplicationsByStaffAcademic(token = null) {
  try {
    ...
    const response = await fetch(
      `${API_BASE_URL}/trainee_application/get_all_trainee_application_by_staff_academic_affair`,
      {
        method: 'GET',
        headers,
        cache: 'no-store'
...
export async function getTraineeApplicationsByStatus(statusEnum, token = null) {
  try {
    ...
    const response = await fetch(
      `${API_BASE_URL}/trainee_application/get_trainee_application_list_by_status_by_staff_academic_staff_affair?statusEnum=${statusEnum}`,
      {
        method: 'GET',
        headers,
        cache: 'no-store'
...
export async function getTraineeApplicationDetailByStaff(traineeApplicationId, token = null) {
  try {
    ...
    const response = await fetch(
      `${API_BASE_URL}/trainee_application/get_trainee_application_detail_by_staff/${traineeApplicationId}`,
      {
        method: 'GET',
        headers,
        cache: 'no-store'
