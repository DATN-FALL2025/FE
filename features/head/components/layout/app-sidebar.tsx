...
export function AppSidebar() {
  ...
  const userEmail = user?.gmail || user?.email || "head@example.com";
  ...
  return (
    <Sidebar collapsible="icon">
            ...
            >
              <Link href="/head/dashboard">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  ...
                  <span className="truncate text-xs">Trang Trưởng Khoa</span>
                </div>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel>Quản lý khoa</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              {navItems.map((item) => {
                const isActive =
